...
class Utils {
  ...
  static antdTableSorter(a, b, key) {
    if (
      typeof getNestedValue(a, key) === 'number' &&
      typeof getNestedValue(b, key) === 'number'
    ) {
      return getNestedValue(a, key) - getNestedValue(b, key);
    }

    if (
      typeof getNestedValue(a, key) === 'string' &&
      typeof getNestedValue(b, key) === 'string'
    ) {
